...
from Yamlok import BOTLOG, BOTLOG_CHATID, CMD_HELP, bot
from Yamlok.utils import register, errors_handler
from Yamlok.utils import admin_cmd
from Yamlok import NAME, MASTER, BOT
# =================== CONSTANT ===================
...
async def spider(spdr):
    ...
    try:
        from Yamlok.modules.sql_helper.spam_mute_sql import mute
...
async def unmoot(unmot):
    ...
    # Check if the function running under SQL mode
    try:
        from Yamlok.modules.sql_helper.spam_mute_sql import unmute
    except AttributeError:
...
async def muter(moot):
    ...
    try:
        from Yamlok.modules.sql_helper.spam_mute_sql import is_muted
