...
from Yamlok.functions.run import run_cmd
...
path = "Yamlok/modules/assistant/*.py"
...
**Dɪɴɢ Dᴏɴɢ...** `.\./.\` **Tɪɴɢ Tᴏɴɢ...** `./.\./` **YAMLOK Hᴀs Bᴇᴇɴ Dᴇᴘʟᴏʏᴇᴅ !!**
**Pɪɴɢ Pᴏɴɢ...**
**➥ Mᴀsᴛᴇʀ** `➪` **@{legend.username}**
**➥ Assɪsᴛᴀɴᴛ** `➪` **@{pro.username}**
**➥ Sᴜᴘᴘᴏʀᴛ** `➪` **@Yamloksupport**
**➥ Cʜᴀɴɴᴇʟ** `➪` **@YamlokOfficial**
