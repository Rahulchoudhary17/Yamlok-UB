...
""" Userbot module for managing events.
 One of the main components of the YAMLOK. """
...
from DaisyX import BOTLOG_CHATID, LOGSPAMMER, bot
        ...
        async def wrapper(check):
            ...
            # This is a gay exception and must be passed out. So that it doesnt spam chats
                ...
                if not disable_errors:
                    ...
                    link = "[Yamlok Official Chat](https://t.me/YamlokOffical)"
                    ...
                    if LOGSPAMMER:
                        await check.client.respond(
                            "`Sorry, my Yamlok has crashed😔, check logs for more info.\
                        \nThe error logs are stored in the Yamlok's log chat.`"
                        )
